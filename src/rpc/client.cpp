...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "pricoin_ct_send", 1, "input_vout" },
    { "pricoin_ct_send", 4, "dest_amount" },
    { "pricoin_ct_send", 6, "fee" },
    { "walletsendct", 1, "dest_amount" },
    { "walletsendct", 2, "fee" },
    { "walletsendct_multi", 0, "recipients" },
    { "walletsendct_multi", 1, "fee" },
    { "walletsendct_locked", 1, "amount" },
    { "walletsendct_locked", 2, "fee" },
    { "walletsendct_locked", 3, "lock_height" },
    ...
    { "pricoin_getsubaddress", 0, "index" },
    { "pricoin_setsubaddresslabel", 0, "index" },
    { "pricoin_setstealthseed", 1, "confirm_overwrite" },
    { "pricoin_jointscan_partial", 1, "vout" },
    { "pricoin_jointscan_recover", 1, "vout" },
    { "pricoin_adaptor_swap_set_pric_funded", 2, "pric_funding_vout" },
    { "pricoin_adaptor_swap_set_pric_funded", 3, "pric_funding_height" },
    { "pricoin_swapwatch_add", 3, "vout" },
    { "pricoin_swapwatch_add", 4, "min_confirmations" },
