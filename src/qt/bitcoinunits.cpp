...
{
    switch (unit) {
    case Unit::BTC: return QString("PRIC");
    case Unit::mBTC: return QString("mPRIC");
    case Unit::uBTC: return QString::fromUtf8("µPRIC");
...
{
    switch (unit) {
    case Unit::BTC: return QString("Pricoins");
    case Unit::mBTC: return QString("Milli-Pricoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-Pricoins (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
