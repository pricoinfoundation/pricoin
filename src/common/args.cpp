...
const char * const BITCOIN_CONF_FILENAME = "pricoin.conf";
...
{
    // Windows: C:\Users\Username\AppData\Local\Pricoin
    // macOS:   ~/Library/Application Support/Pricoin
    // Unix:    ~/.pricoin
#ifdef WIN32
    return GetSpecialFolderPath(CSIDL_LOCAL_APPDATA) / "Pricoin";
#else
    fs::path pathRet;
...
#ifdef __APPLE__
    // macOS
    return pathRet / "Library/Application Support/Pricoin";
#else
    // Unix-like
    return pathRet / ".pricoin";
#endif
#endif
}
